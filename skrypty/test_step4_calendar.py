...
def run_gateway(log):
    ...
    log.info('MAIN', '═' * 50)
    log.info('MAIN', f'GATEWAY {gw_id} running (STEP 4 — KALENDARZ + SLOTOWANIE)')
...
def run_supervisor(log):
    ...
    log.info('MAIN', '═' * 50)
    log.info('MAIN', f'SUPERVISOR running (STEP 4 — KALENDARZ + SLOTOWANIE) gateways={known_gateways}')
...
def main():
    log = Log()
    log.info('MAIN', '═' * 50)
    log.info('MAIN', 'STEP 4 — KALENDARZ + SLOTOWANIE')
